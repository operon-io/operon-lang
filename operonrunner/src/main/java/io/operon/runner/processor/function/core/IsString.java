...
/**
 *
 * Check if value is String. Returns true or false.
 *
 */
public class IsString extends BaseArity0 implements Node, Arity0 {
     // no logger 
    
    public IsString(Statement statement) throws OperonGenericException {
        super(statement);
        this.setFunctionName("isString");
