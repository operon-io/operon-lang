...
/**
 *
 * Check if value is empty. Returns true or false.
 *
 */
public class IsEmpty extends BaseArity0 implements Node, Arity0 {
     // no logger 
    
    public IsEmpty(Statement statement) throws OperonGenericException {
        super(statement);
        this.setFunctionName("isEmpty");
