...
public class ErrorGetType extends BaseArity0 implements Node, Arity0 {
    
    public ErrorGetType(Statement statement) throws OperonGenericException {
        super(statement);
        this.setFunctionName("getType");
    ...
    public StringType evaluate() throws OperonGenericException {
        try {
            ...
            result.setFromJavaString(currentValue.getType());
            return result;
        } catch (Exception e) {
