...
public class MathSin extends BaseArity0 implements Node, Arity0 {

    public MathSin(Statement statement) {
        super(statement);
        this.setFunctionName("sin");
    ...
    public NumberType evaluate() throws OperonGenericException {        
        try {
            ...
            double sinValue = Math.sin( ((NumberType) currentValue).getDoubleValue() );
            ...
            result.setDoubleValue(sinValue);
            return result;
        } catch (Exception e) {
