 ...
 *
 */
public class IsEmptyString extends BaseArity0 implements Node, Arity0 {
     // no logger 
    
    public IsEmptyString(Statement statement) throws OperonGenericException {
        super(statement);
        this.setFunctionName("isEmptyString");
    ...
    public OperonValue evaluate() throws OperonGenericException {
        ...
        if (currentValue instanceof StringType) {
            ...
            if (str.getJavaStringValue().isEmpty()) {
