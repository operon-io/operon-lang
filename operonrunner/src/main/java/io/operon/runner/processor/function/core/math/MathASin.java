...
public class MathASin extends BaseArity0 implements Node, Arity0 {

    public MathASin(Statement statement) {
        super(statement);
        this.setFunctionName("arcsin");
    ...
    public NumberType evaluate() throws OperonGenericException {        
        try {
            ...
            double asinValue = Math.asin( ((NumberType) currentValue).getDoubleValue() );
            ...
            result.setDoubleValue(asinValue);
            return result;
        } catch (Exception e) {
