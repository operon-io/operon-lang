 ...
 *
 */
public class IsEmptyObject extends BaseArity0 implements Node, Arity0 {
     // no logger 
    
    public IsEmptyObject(Statement statement) throws OperonGenericException {
        super(statement);
        this.setFunctionName("isEmptyObject");
