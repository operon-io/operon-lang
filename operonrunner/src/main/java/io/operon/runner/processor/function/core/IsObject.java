...
/**
 *
 * Check if value is Object. Returns true or false.
 *
 */
public class IsObject extends BaseArity0 implements Node, Arity0 {
     // no logger 
    
    public IsObject(Statement statement) throws OperonGenericException {
        super(statement);
        this.setFunctionName("isObject");
