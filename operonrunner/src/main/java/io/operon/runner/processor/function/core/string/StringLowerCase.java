...
public class StringLowerCase extends BaseArity0 implements Node, Arity0 {
    
    public StringLowerCase(Statement statement) {
        super(statement);
        this.setFunctionName("lowerCase");
    ...
    public StringType evaluate() throws OperonGenericException {        
        try {
            ...
            result.setValue(result.getStringValue().toLowerCase());
            return result;
        } catch (Exception e) {
