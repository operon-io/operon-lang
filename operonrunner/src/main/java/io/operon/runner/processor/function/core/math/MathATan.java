...
public class MathATan extends BaseArity0 implements Node, Arity0 {

    public MathATan(Statement statement) {
        super(statement);
        this.setFunctionName("arctan");
    ...
    public NumberType evaluate() throws OperonGenericException {        
        try {
            ...
            double atanValue = Math.atan( ((NumberType) currentValue).getDoubleValue() );
            ...
            result.setDoubleValue(atanValue);
            return result;
        } catch (Exception e) {
