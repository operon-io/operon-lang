...
public class StringStripRight extends BaseArity0 implements Node, Arity0 {
    
    public StringStripRight(Statement statement) {
        super(statement);
        this.setFunctionName("stripRight");
    }
    ...
    public StringType evaluate() throws OperonGenericException {        
        try {
            ...
            result.setFromJavaString(result.getJavaStringValue().stripTrailing());
            return result;
        } catch (Exception e) {
