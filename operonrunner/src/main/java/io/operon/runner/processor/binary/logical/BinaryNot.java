...
/**
 * 
 * This is used for "expr NOT expr", which allows e.g. `Select: When @ Not EmptyString: true;`
 * Instead of "NOT expr", which would require: `Select: When Not @ EmptyString: true;`
 * Both may be used, but the first is more natural.
 * 
 */
public class BinaryNot extends BaseBinaryNodeProcessor implements BinaryNodeProcessor {

    @Expose private String binaryOperator = "Not";
