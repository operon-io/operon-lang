...
public class PathSame extends BaseArity2 implements Node, Arity2 {
    ...
    public PathSame(Statement statement, List<Node> params) throws OperonGenericException {
        super(statement);
        this.setParam2AsOptional(true);
        this.setParams(params, "same", "value", "value2");
    }
    ...
    public ArrayType evaluate() throws OperonGenericException {
        try {
            ...
            if (this.getParam2() == null) {
                ...
                result = this.getSame(value1, value2);
            }
    ...
    private ArrayType getSame(OperonValue value1, OperonValue value2) throws OperonGenericException {
        ...
        List<Node> sameList = new ArrayList<Node>();
