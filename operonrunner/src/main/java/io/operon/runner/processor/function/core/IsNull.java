...
/**
 *
 * Check if value is null. Returns true or false.
 *
 */
public class IsNull extends BaseArity0 implements Node, Arity0 {
     // no logger 
    
    public IsNull(Statement statement) throws OperonGenericException {
        super(statement);
        this.setFunctionName("isNull");
