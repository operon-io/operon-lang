...
public class StringPadLeft extends BaseArity2 implements Node, Arity2 {
    ...
    public StringPadLeft(Statement statement, List<Node> params) throws OperonGenericException {
        super(statement);
        String param1Name = "padWith";
        String param2Name = "padToLength";
        this.setParams(params, "padLeft", param1Name, param2Name);
    ...
    public StringType evaluate() throws OperonGenericException {        
        try {
            ...
            if (resultString.length() < padToLengthInt) {
                ...
                resultString = padding + resultString;
            }
