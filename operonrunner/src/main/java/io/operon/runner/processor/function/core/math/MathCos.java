...
public class MathCos extends BaseArity0 implements Node, Arity0 {

    public MathCos(Statement statement) {
        super(statement);
        this.setFunctionName("cos");
    ...
    public NumberType evaluate() throws OperonGenericException {        
        try {
            ...
            double cosValue = Math.cos( ((NumberType) currentValue).getDoubleValue() );
            ...
            result.setDoubleValue(cosValue);
            return result;
        } catch (Exception e) {
