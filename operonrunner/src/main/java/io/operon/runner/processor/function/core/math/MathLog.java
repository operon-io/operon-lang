...
public class MathLog extends BaseArity0 implements Node, Arity0 {

    public MathLog(Statement statement) {
        super(statement);
        this.setFunctionName("log");
    ...
    public NumberType evaluate() throws OperonGenericException {        
        try {
            ...
            double logValue = Math.log( ((NumberType) currentValue).getDoubleValue() );
            ...
            result.setDoubleValue(logValue);
            return result;
        } catch (Exception e) {
