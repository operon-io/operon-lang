...
public class MathAbs extends BaseArity0 implements Node, Arity0 {

    public MathAbs(Statement statement) {
        super(statement);
        this.setFunctionName("abs");
    ...
    public NumberType evaluate() throws OperonGenericException {        
        try {
            ...
            double absValue = Math.abs( ((NumberType) currentValue).getDoubleValue() );
            ...
            result.setDoubleValue(absValue);
            return result;
        } catch (Exception e) {
