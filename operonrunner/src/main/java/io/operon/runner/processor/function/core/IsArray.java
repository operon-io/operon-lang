...
/**
 *
 * Check if value is Array. Returns true or false.
 *
 */
public class IsArray extends BaseArity0 implements Node, Arity0 {
     // no logger 
    
    public IsArray(Statement statement) throws OperonGenericException {
        super(statement);
        this.setFunctionName("isArray");
