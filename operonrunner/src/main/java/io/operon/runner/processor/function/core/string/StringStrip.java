...
public class StringStrip extends BaseArity0 implements Node, Arity0 {
    
    public StringStrip(Statement statement) {
        super(statement);
        this.setFunctionName("strip");
    ...
    public StringType evaluate() throws OperonGenericException {        
        try {
            ...
            result.setFromJavaString(result.getJavaStringValue().strip());
            return result;
        } catch (Exception e) {
