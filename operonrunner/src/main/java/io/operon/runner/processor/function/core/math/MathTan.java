...
public class MathTan extends BaseArity0 implements Node, Arity0 {

    public MathTan(Statement statement) {
        super(statement);
        this.setFunctionName("tan");
    ...
    public NumberType evaluate() throws OperonGenericException {        
        try {
            ...
            double tanValue = Math.tan( ((NumberType) currentValue).getDoubleValue() );
            ...
            result.setDoubleValue(tanValue);
            return result;
        } catch (Exception e) {
